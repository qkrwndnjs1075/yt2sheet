# Release cli-v0.2.23 (2026-08-05)

## Plan

- [x] Prepare the 0.2.23 patch version and release-fix worktree while preserving local PDF/npm artifacts.
...
- [ ] Push the commit directly to `main` and push the cli-v0.2.23 tag.
